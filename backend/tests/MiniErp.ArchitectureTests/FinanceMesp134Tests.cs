...
public sealed class FinanceMesp134Tests
{
    ...
    private sealed class Fixture : IAsyncDisposable
    {
        ...
        internal static async Task<Fixture> CreateAsync(bool includeReportingRate = false)
        {
            ...
            var persistence = new FinanceMesp134Persistence(options, companies, currency, rates, taxService, new EmptySupplierInvoiceSourceProvider());
            return new Fixture(connection, masterDataConnection, options, context!, companies, taxService, persistence, createdTax.Value!.Id, openItemId, accountA.Value.Id, rates);
        }
