...
public static class InventoryEndpoints
{
    public static IEndpointRouteBuilder MapInventoryEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        MapValuationGet<IReadOnlyList<InventoryValuationReconciliationRecord>>(endpoints, "/api/v1/inventory/valuation/summary", "inventory.valuation.summary.read", (context, http, valuation) => valuation.ReconcileAsync(context, ParseValuationQuery(http), http.RequestAborted));
