...
public static class PriceListEndpoints
{
    ...
    private static PriceListReferenceResponse ToReferenceResponse(MasterDataPriceListReferenceRecord record) => new(
        ...
        record.Price.CurrencyId,
        record.Price.CurrencyCode,
        record.Price.CustomerId,
        record.Price.OrganizationScopeKind,
        record.Price.OrganizationScopeId,
        record.Price.Priority,
        record.EffectiveOn,
